...
public class MortgageCal {
    ...
    public static void main(String[] args) {       
        ...
        String formatedMonthlyAmount = formatAmount(mortgage);
    ...
    public static double findMortgage(int principal,float monthlyRate,short noOfPayments) {
        return principal *(monthlyRate * Math.pow((1+monthlyRate),noOfPayments))/(Math.pow((1+monthlyRate),noOfPayments)-1);
